  ...
  const faqs = [
    {
      ...
      a: "A click-to-chat link lets anyone open a WhatsApp conversation with you in one tap — no need to save the number first. Share it on your website, bio, or anywhere online.",
    },
    {
      q: "Do I need a WhatsApp Business account?",
      a: "No. These links work with any standard WhatsApp account. WhatsApp Business accounts also benefit from the same links.",
    },
    {
      q: "What is the difference between wa.me and api.whatsapp.com links?",
      a: "Both open a WhatsApp chat, but wa.me (short link) is cleaner and preferred for sharing. api.whatsapp.com is the official API format, useful for certain integrations.",
    },
    {
      q: "Is my phone number stored anywhere?",
      a: "No. Everything is generated entirely in your browser. We never store, log, or transmit your phone number or message to any server.",
    },
    {
      q: "Can I add a pre-filled message to the link?",
      a: "Yes! Enter a message in the Custom Message field and it will be automatically pre-filled when the recipient opens the chat.",
    },
    {
      q: "How does the Bulk Creator work?",
      a: "Paste a list of phone numbers (one per line, or comma-separated) into the Import modal. The tool parses country codes automatically and generates individual WhatsApp links for each number.",
    },
  ];
  ...
  const features = [
    {
      ...
      desc: "Links are created in real time as you type — no forms, no waiting, no sign-up required.",
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      title: "40+ Countries",
      desc: "Choose from a curated list of 40+ countries with correct dial codes and flag icons.",
    },
    {
      icon: (
        <svg
      ...
      title: "Bulk Creator",
      desc: "Import hundreds of phone numbers at once, assign messages, and export as CSV or TXT.",
    },
    {
      icon: (
        <svg
      ...
      title: "QR Code",
      desc: "Every link comes with a downloadable QR code — perfect for print, packaging, or signage.",
    },
    {
      icon: (
        <svg
      ...
      title: "Emoji Picker",
      desc: "Add expressive emojis to your pre-filled messages with a full built-in emoji library.",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-28 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900 mb-6 leading-tight animate-fade-in-up animation-delay-100">
            ...
            <span className="relative inline-block">
              <span className="relative z-10 text-emerald-600">Instantly</span>
              <svg
          ...
          <p className="max-w-2xl mx-auto text-lg sm:text-xl text-gray-600 leading-relaxed mb-12 animate-fade-in-up animation-delay-200">
            Generate click-to-chat WhatsApp links for single contacts or in
            bulk. Add pre-filled messages, emojis, and downloadable QR codes —
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="max-w-2xl mx-auto text-gray-500 text-lg leading-relaxed">
              A clean, fast, privacy-first WhatsApp link generator built for
